...
export default function DoctorAppointmentsTab() {
  ...
  // 2. Appointments State (initialized with exact mockup row + additional dates for realistic filtering)
  ...
  const handleAcceptAppointment = (id) => {
    ...
    setNotification(`Appointment for ${target ? target.pName : 'patient'} confirmed successfully!`);
    ...
    <div className="doctor-manage-appointments-wrapper">
      ...
      <div className="doctor-manage-appointments-card">
        ...
        <div className="doctor-appointment-inner-card">
          ...
          {/* Filter Date Bar (kept as explicitly requested) */}
          <div className="doctor-appointments-filter-bar">
            <div className="doctor-filter-group">
              <label htmlFor="doctor-filter-date" className="doctor-filter-label">
                <span>📅</span> Filter Date:
              </label>
              <input
                id="doctor-filter-date"
                type="date"
                value={filterDate}
                        ...
                        {item.status === 'pending' ? (
                          <div className="mockup-actions-cell">
                            <button
                              ...
                              title="Confirm / Accept Appointment"
