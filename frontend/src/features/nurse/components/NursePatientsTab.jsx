...
export default function NursePatientsTab() {
      ...
      pendingVaccines: [
        {
          ...
          dosage: '50ml',
          prescribedBy: 'Dr. Samantha Perera',
        },
      ],
    },
    {
      ...
      pendingVaccines: [
        {
          ...
          location: 'Lanka hospital- colombo',
          dosage: '0.5ml',
          prescribedBy: 'Dr. S. K. Jayasuriya',
        },
      ],
    },
    {
  ...
  const handleSelectPatient = (patient) => {
    ...
    setNotification(`Patient record loaded: ${patient.name} (${patient.vaxoraId})`);
  ...
  return (
    <div className="doctor-patient-history-page nurse-patient-history-page">
      ...
      {showDetailsCard && selectedPatient && (
        <section className="patient-details-card-container">
          ...
          {/* Section 3: Pending Vaccine Table (Nurse Read-Only Dosage Level) */}
          <div>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
              <h3 className="patient-section-heading" style={{ margin: 0 }}>Pending Vaccine</h3>
                  ...
                  {selectedPatient.pendingVaccines && selectedPatient.pendingVaccines.length > 0 ? (
                    selectedPatient.pendingVaccines.map((pv) => (
                      <tr key={pv.id}>
                        ...
                        <td>{pv.location}</td>
                        <td>
                          {/* STRICTLY READ-ONLY FOR NURSE PORTAL */}
                          <div className="nurse-dosage-cell" title={`Dosage prescribed by physician: ${pv.dosage}`}>
                            <span className="nurse-dosage-badge">
                              {pv.dosage}
                            </span>
                            <span className="nurse-prescribed-tag">
                              🔒 Prescribed
                            </span>
                          </div>
                        </td>
