  ...
  useEffect(() => {
    const fetchLatestProfile = async () => {
      try {
        ...
        console.warn(
          "Could not fetch latest user profile for dashboard banner:",
          err,
        );
      }
    };
      ...
      <div className="patient-welcome-banner">
        <div className="welcome-text-group">
          ...
          <p className="welcome-subtitle">
            Your Vaxora immunization pass is cryptographically verified and
            up-to-date. Your next booster dose is confirmed for October 12,
            2026.
          </p>
        </div>
          ...
          <div className="patient-panel-card">
            ...
            <div className="spotlight-appointment">
              <div className="appointment-meta-top">
                <span className="vaccine-badge-pill">
              ...
              <div className="appointment-actions-row">
                ...
                <button
                  ...
                  onClick={() =>
                    alert(
                      "Appointment Slip #VX-88349 sent to your registered email.",
                    )
                  }
                >
