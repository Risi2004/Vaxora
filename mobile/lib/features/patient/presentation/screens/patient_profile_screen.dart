...
class _PatientProfileScreenState extends State<PatientProfileScreen> {
  ...
  final _dobController = TextEditingController(text: '1998-05-24');
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const Text(
                    'National Registration: VAX-P-883492',
            ...
            _buildSectionCard(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                _buildField(label: 'Date of Birth', controller: _dobController, enabled: _isEditing),
                const SizedBox(height: 12),
            ...
            // 3. Clinical & Allergy Records Preview
            _buildSectionCard(
              title: 'Medical & Allergy Profile',
              icon: Icons.medical_services_outlined,
              children: [
                _buildStaticRow('Blood Group', 'O Positive (O+)'),
                const Divider(color: AppColors.borderLight, height: 16),
                _buildStaticRow('Known Allergies', 'Penicillin, Shellfish'),
                const Divider(color: AppColors.borderLight, height: 16),
                _buildStaticRow('Chronic Conditions', 'Mild Asthma'),
                const Divider(color: AppColors.borderLight, height: 16),
                _buildStaticRow('Special Medical Notes', 'Patient requires 15-min post-vaccination observation'),
              ],
            ),
            const SizedBox(height: 16),
